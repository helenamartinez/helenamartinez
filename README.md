## 🌟 Olá! Sou Helena - Cientista de Dados 👩🏻‍💻

Apaixonada por tecnologia e com um brilho nos olhos em cada projeto. Meu trabalho é desvendar uns quebra-cabeças de dados, e ser a ponte que conecta o insight técnico à decisão estratégica de negócio.
Atualmente, faço parte da equipe de Data & IA na Porto - Porto Bank, onde atuo com Advanced Analytics, criando produtos de dados para soluções analíticas, P&D e cross-selling.

🗺️ Minha Bússola Analítica é o PROBLEMA! Gosto de áreas críticas e amo os desafios que elas trazem consigo, onde cada detalhe e atenção fazem toda a diferença para a resolução de problemas.
